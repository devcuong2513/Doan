...
public class MainGameActivity extends Activity{
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case CHECK_ANWSER:
                        if (checkAnwser()) {
                            Toast.makeText(MainGameActivity.this, "Bạn Đúng Là Thiên Tài !", Toast.LENGTH_SHORT).show();
                            point += 100;
                            ...
                            Toast.makeText(MainGameActivity.this, "Đáp án sai !", Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    case GAME_OVER:
                        Toast.makeText(MainGameActivity.this, "GAME OVER", Toast.LENGTH_SHORT).show();
                        finish();
                        break;
                    default:
                        break;
    ...
    private void initComponets() {
        ...
        listQuestions.add(new Question(R.drawable.a, "a"));
        listQuestions.add(new Question(R.drawable.b, "b"));
        listQuestions.add(new Question(R.drawable.c, "c"));
        listQuestions.add(new Question(R.drawable.d, "d"));
        listQuestions.add(new Question(R.drawable.e, "e"));
        listQuestions.add(new Question(R.drawable.f, "f"));
        listQuestions.add(new Question(R.drawable.g, "g"));
        listQuestions.add(new Question(R.drawable.h, "h"));
        listQuestions.add(new Question(R.drawable.i, "i"));
        listQuestions.add(new Question(R.drawable.j, "j"));
        listQuestions.add(new Question(R.drawable.k, "k"));
        listQuestions.add(new Question(R.drawable.l, "l"));
        listQuestions.add(new Question(R.drawable.m, "m"));
        listQuestions.add(new Question(R.drawable.n, "n"));
        listQuestions.add(new Question(R.drawable.o, "o"));
        listQuestions.add(new Question(R.drawable.p, "p"));
        listQuestions.add(new Question(R.drawable.q, "q"));
        listQuestions.add(new Question(R.drawable.r, "r"));
        listQuestions.add(new Question(R.drawable.s, "s"));
        listQuestions.add(new Question(R.drawable.t, "t"));
        listQuestions.add(new Question(R.drawable.u, "u"));
        listQuestions.add(new Question(R.drawable.v, "v"));
        listQuestions.add(new Question(R.drawable.w, "w"));
        listQuestions.add(new Question(R.drawable.x, "x"));
        listQuestions.add(new Question(R.drawable.y , "y"));
        listQuestions.add(new Question(R.drawable.z ,"z"));
